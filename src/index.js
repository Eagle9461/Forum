...
import ForumCategories from "views/pages/ForumCategories";
      ...
      <BrowserRouter>
        <Switch>
          <Switch>
            ...
            <Route path="/forumdetail" render={(props) => <ForumDetail {...props} />} />
            <Route path="/forumCategories" render={(props) => <ForumCategories {...props} />} />
